...
def money():
    ...
    if request.form['gold'] == 'cave' and 'gold' in session:
        ...
        arr.append(f'Oh look it here I have money now!')
    print(session['gold'])
    print(arr)
    return redirect('/')
